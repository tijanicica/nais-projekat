...
//    // DTO for rating to avoid exposing WatchedRelationship model directly
...
//        } catch (RuntimeException e) {
//            return ResponseEntity.badRequest().body(null); // Handle specific exceptions for better error messages
//        }
//    }
//
...
//    public List<UserRepository.ActorGenreCountProjection> getActorsByMostGenres(@RequestParam(defaultValue = "5") int limit) {
